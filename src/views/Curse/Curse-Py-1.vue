<template>
  <div class="wrapper">
    <main class="page">
        <div class="curs_py_1">
            <div class="curs_py_1__container _container">
                <div class="curs_py_1__wrapper">
                    <div class="curs_py_1__headBlock">
                        <div class="curs_py_1__items">
                            <div class="curs_py_1__block"><img src="../../assets/img/curses/play.svg"></div>
                            <div class="curs_py_1__block"><img src="../../assets/img/curses/pen.svg"></div>
                            <div class="curs_py_1__block"><img src="../../assets/img/curses/play.svg"></div>
                            <div class="curs_py_1__block"><img src="../../assets/img/curses/pen.svg"></div>
                        </div>
                    </div>
